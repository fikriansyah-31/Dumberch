        ...
        <Row className="vh-100 align-items-center justify-content-center py-md-0 py-5">
          <Col md={6} className="text-md-start text-center ">
            ...
            <p className="text-var-gray">
              Go shopping for merchandise, just go to Kopan Coffe shopping the biggest merchandise in <span className="text-var-gray fw-bold">Indonesia</span>
            </p>
            <div className="mt-lg-5 mt-2 mb-lg-0 mb-5 text-md-start text-center ">
              <button className="btn-danger px-5 me-2" onClick={switchLogin}>
                Login
              </button>
              <button className="btn-danger px-5 text-light " onClick={switchRegister}>
                Register
              </button>
            </div>
          </Col>
